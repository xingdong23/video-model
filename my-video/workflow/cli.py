...
if TYPE_CHECKING:
    if __package__ in (None, ""):
        from workflow.engine import WorkflowEngine  # type: ignore
    else:
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Integrated my-video workflow for audio, digital human, and subtitles")
    ...
    bgm_source.add_argument("--bgm-name", help="Preset BGM track name from bgm/library")
    bgm_source.add_argument("--bgm-random", action="store_true", help="Randomly select a preset BGM track from bgm/library")
