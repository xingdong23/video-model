...
if __package__ in (None, ""):
    ...
    from rewrite.engine import RewriteEngine, RewriteError  # type: ignore
else:
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Reusable copywriting rewrite module for my-video")
