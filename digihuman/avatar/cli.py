...
if __package__ in (None, ""):
    ...
    from avatar.engine import DigitalHumanEngine  # type: ignore
else:
    from .engine import DigitalHumanEngine


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Standalone TuiliONNX digital human video generator for DigiHuman")
