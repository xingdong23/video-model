...
export DIGIHUMAN_DIGITAL_HUMAN_WARMUP="${DIGIHUMAN_DIGITAL_HUMAN_WARMUP:-1}"
export DIGIHUMAN_REFERENCE_CACHE_SIZE="${DIGIHUMAN_REFERENCE_CACHE_SIZE:-2}"
export DIGIHUMAN_REFERENCE_PREPACK="${DIGIHUMAN_REFERENCE_PREPACK:-1}"
